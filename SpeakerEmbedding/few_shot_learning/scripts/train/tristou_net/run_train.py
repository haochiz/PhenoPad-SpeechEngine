...
parser.add_argument('--data.way', type=int, default=15, metavar='WAY',
                    help="number of classes per episode (default: 40)")
...
parser.add_argument('--data.cuda', action='store_true', help="run in CUDA mode (default: True)")

# model args
default_model_name = 'tristou_net'
...
parser.add_argument('--model.in_dim', type=str, default='1,200,59', metavar='INDIM',
                    help="dimensionality of input audio segments (default (2s): '1,200,59')")
